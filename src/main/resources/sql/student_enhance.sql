-- 扩展 sys_user 表学生字段
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS gender CHAR(1) DEFAULT '0' COMMENT '性别 0-男 1-女';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS birth_date DATE COMMENT '出生日期';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS id_card VARCHAR(18) COMMENT '身份证号';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS nation VARCHAR(20) DEFAULT '汉' COMMENT '民族';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS political_status TINYINT DEFAULT 0 COMMENT '政治面貌 0-群众 1-团员 2-党员';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS native_place VARCHAR(100) COMMENT '生源地';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS home_address VARCHAR(255) COMMENT '家庭地址';
ALTER TABLE sys_user ADD COLUMN IF NOT EXISTS avatar VARCHAR(255) COMMENT '头像/照片URL';
